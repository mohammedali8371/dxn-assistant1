...
function isStartupQuery(text) {
  const lower = text.toLowerCase();
  const keywords = ["كيف أبدا", "كيفية البدء", "كيف اربح", "كيف أبدأ", "بدء", "البداية", "التسجيل", "الدورات", "تدريب", "كيف اشترك", "طريقة الانضمام", "انضمام", "عضو", "رابط", "لقاء", "اجتماع", "meet", "الأحد", "الاحد", "join", "register"];
