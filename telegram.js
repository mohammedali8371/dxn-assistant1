...
function isStartupQuery(text) {
  ...
  const keywords = [
    ...
    'كيف ابدا', 'كيف أبدا', 'كيف ابدأ', 'كيف أبدأ', 'كيف ابداء', 'كيف ابدي',
    'طريقة البدء', 'خطوات البدء', 'طريقه البدء',
    ...
    'كيف اسجل', 'كيف أسجل', 'كيف اتسجل', 'كيف تسجل', 'كيف اشترك', 'كيف أشترك',
    'كيف انضم', 'كيف أنضم', 'كيف انظم', 'طريقة التسجيل', 'طريقه التسجيل',
    'رابط التسجيل', 'رابط الاشتراك', 'رابط العضوية',
    'ماهي الطريقة', 'ما هي الطريقة', 'ما هي طريقه', 'ماهي طريقه', 'ما الطريقه',
    'وش الطريقة', 'وش طريقه', 'شنو الطريقة', 'ايش الطريقة', 'كيف الطريقة',
    ...
    'كيفية التسجيل', 'كيفيه التسجيل', 'طريقة الاشتراك', 'خطوات الاشتراك',
    'كيف ابدا مع dxn', 'كيف ابدأ مع dxn', 'كيف ابدا في dxn', 'كيف ابدأ في dxn'
  ];
...
function detectPDFRequest(text) {
  ...
  const companyKeywords = ['تعريف', 'الشركة', 'دي اكس ان', 'دي إكس ان', 'dxn', 'برنامج تعريفي', 'عن dxn', 'ما هي dxn', 'ما هو dxn', 'ما هي دي اكس ان', 'ما هو دي اكس ان', 'ما هي شركة', 'ما هو شركة', 'تعرف', 'تعرف على', 'نبذة عن', 'اشتغل', 'اشتغل معاكم', 'أشتغل معكم', 'اعمل معاكم', 'بدي اشتغل', 'ابغى اشتغل', 'أريد العمل', 'اريد العمل', 'ما العمل', 'ايش تعمل', 'ماهي الفرصة', 'ما هي الفرصة', 'الفرصة', 'فرصة عمل', 'وظيفة'];
