...
function isStartupQuery(text) {
  ...
  // قائمة موسعة جداً تشمل كل المرادفات والصيغ (مفرد، جمع، مذكر، مؤنث، أمر، مضارع، ماضي)
  const keywords = [
    // البدء والبداية
  ...
  // فحص إضافي للكلمات التي تحتوي على جذور (بدأ، سجل، انضم) مع أي بادئات
  const rootPatterns = [
    /ب[دأا][ءأ]?/,      // بدأ، بدء، بدا
    /س[جج]ل/,          // سجل، سجّل
    /ا[نن]ضم/,         // انضم
    /ا[شش]ترك/,        // اشترك
    /لق[اء]/,          // لقاء
